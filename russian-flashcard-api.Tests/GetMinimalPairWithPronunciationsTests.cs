...
public class GetMinimalPairWithPronunciationsTests
{
    private readonly Mock<ILogger<GetMinimalPairWithPronunciations>> _mockLogger;

    public GetMinimalPairWithPronunciationsTests()
    {
        _mockLogger = new Mock<ILogger<GetMinimalPairWithPronunciations>>();
    }
    ...
    {
        // Arrange
        var function = new GetMinimalPairWithPronunciations(_mockLogger.Object);
    ...
    [Fact]
    public async Task Run_WithValidRowId_FetchesMinimalPairData()
    {
        // Arrange
        var function = new GetMinimalPairWithPronunciations(_mockLogger.Object);
        var mockRequest = new Mock<HttpRequest>();
